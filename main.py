...
def get_data(act_id, act_name):
    ...
    url = 'https://graph.facebook.com/v2.5/act_%d/adsets?fields=name,start_time,end_time,targeting,targetingsentencelines,insights{spend}&limit=15&access_token=%s' % (act_id, my_access_token)
...
paginated_json_to_csv('Arbor_Mist_data_pull.json')
